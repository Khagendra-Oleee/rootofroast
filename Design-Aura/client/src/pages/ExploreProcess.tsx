...
import { ArrowLeft, Play, Clock, Thermometer, Droplets, Coffee, ChevronDown } from "lucide-react";
...
const coffeeProcesses = [
  {
    ...
    image: espressoImg,
    videoUrl: "https://www.youtube.com/embed/Z-iNAyu-ejo?si=xg8F3x_2bGOxqIbl",
    duration: "25-30 sec",
    temperature: "92-96°C",
    waterRatio: "1:2",
    steps: [
  ...
  },
  {
    ...
    image: cappuccinoImg,
    videoUrl: "https://www.youtube.com/embed/BIYBxmhg4Gs?si=PqN5c8-fN6qKQXnZ",
    duration: "2-3 min",
    temperature: "65-70°C",
    waterRatio: "1:1:1",
    steps: [
  ...
  },
  {
    ...
    image: caffeLatteImg,
    videoUrl: "https://www.youtube.com/embed/CbLS2rrm0wk?si=PqN5c8-fN6qKQXnZ",
    duration: "3-4 min",
    temperature: "60-65°C",
    waterRatio: "1:3",
    steps: [
  ...
  },
  {
    ...
    image: coldBrewImg,
    videoUrl: "https://www.youtube.com/embed/qWAagS_MANg?si=PqN5c8-fN6qKQXnZ",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-24">
              ...
              >
                ...
                <ClickSpark sparkColor="#D4A574">
                  <ShinyButton onClick={() => setShowVideo(true)} className="w-full justify-center">
              ...
              >
                <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                  ...
                  >
                    <motion.div 
                      className="w-20 h-20 rounded-full bg-primary/90 flex items-center justify-center group-hover:bg-primary transition-colors shadow-lg"
          ...
          >
            ...
            >
              <iframe
                ...
                title={`${activeProcess.name} Making Process`}
